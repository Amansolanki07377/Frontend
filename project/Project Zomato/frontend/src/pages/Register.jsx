            ...
            <div className="w-full max-w-md rounded-[2.5rem] bg-white/95 border border-slate-200 shadow-2xl shadow-slate-300/20 backdrop-blur-xl overflow-hidden">
                <div className="p-8 md:p-12">
                    <div className="text-center mb-10">
                        <span className="inline-flex rounded-full bg-primary/10 text-primary px-4 py-2 text-sm font-semibold uppercase tracking-[0.25em] mb-4">Create account</span>
                        <h2 className="text-4xl font-black text-slate-900 mb-3">Sign Up</h2>
                        <p className="text-slate-500">Create your account to start ordering</p>
                    </div>
